...
def evaluate():
    ...
    print("Improved EfficientNet-B0 Test Evaluation")
    print("=" * 60)
    ...
    print("IMPROVED B0 TEST SET RESULTS")
    ...
    plt.title(
        "Improved EfficientNet-B0 - V2 Test Confusion Matrix"
    )
    ...
    confusion_path = (
        PLOT_DIR
        / "confusion_matrix_b0_improved_test.png"
    )
    ...
    print(
        "\nImproved B0 evaluation completed."
    )
